...
$ads_txt_themoneytizer = file_get_contents('https://www.themoneytizer.com/ads.txt?id=83919');
if(empty($ads_txt_themoneytizer)){
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_URL, 'https://www.themoneytizer.com/ads.txt?id=83919');
