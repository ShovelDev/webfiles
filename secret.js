...
if(ester == 1){
	...
	f = `document.querySelector("html").style.background = "yellow";document.querySelector("body").style.background = "yellow";document.body.style.color = "white";document.getElementById("logo1").src="icons/pizza.png"`
}
if(ester == 2){
